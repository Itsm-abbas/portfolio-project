...
import Lawut from "./Descriptions/Lawut";
import BCG from "./Descriptions/BCG";
import POI from "./Descriptions/POI";
import Maersk from "./Descriptions/Maersk";
import PWC from "./Descriptions/PWC";
import Gojek from "./Descriptions/Gojek";
import Uber from "./Descriptions/Uber";
export default function WhereIHaveWorked() {
  ...
  const GetInternshipDescription = () => {
    switch (DescriptionIntership) {
      case "Maersk":
        return <Maersk />;
      case "PWC":
        return <PWC />;
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Lawut");
  const [DescriptionIntership, setIntershipDescription] =
    React.useState("Maersk");
  return (
    <div
      data-aos="fade-up"
    ...
    >
      ...
      justify-center md:justify-center items-center md:items-start "
      >
        {/* // ? Left side of Internship, contains the bar and name of companies */}
        <CompaniesBarInternship
          setIntershipDescription={setIntershipDescription}
        />
        {/* // ? Description for The internship */}
        {GetInternshipDescription()}
      </section>
    </div>
  );
}
    ...
    return (
      <button
        onClick={() => {
          setBarPosition(props.BarPosition);
          setBarAbovePosition(props.BarAvobePosition);
          props.setIntershipDescription(props.DescriptionJob);
          setCompanyNameBackgroundColorGreen(
            props.CompanyNameBackgroundColorGreen
          );
        }}
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            BarPosition={-8}
            BarAvobePosition={1}
            DescriptionJob="Maersk"
            CompanyNameBackgroundColorGreen={[true, false, false, false]}
            setIntershipDescription={props.setIntershipDescription}
          />
          <CompanyButton
            ButtonOrderOfcompanyNameBackgroundColorGreen={1}
            CompanyName="PWC"
