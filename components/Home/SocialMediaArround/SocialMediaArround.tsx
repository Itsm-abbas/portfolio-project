  ...
  return (
    ...
    >
      <a href={props.href} className="" target={"_blank"} rel="noreferrer">
        <props.Icon
          className={
            "w-6 h-6 text-gray-500 hover:text-AAsecondary fill-current hover:cursor-pointer"
          }
        />
      </a>
    </motion.div>
    ...
    <>
        ...
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
              href={"https://www.linkedin.com/in/itsmabbas2004/"}
            />
            {/* Github Icon */}
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/Itsm-abbas"}
            />
            {/* Instagram Icon */}
            <IconClickableWithAnimation
              Icon={InstagramIcon}
              href={"https://www.instagram.com/itsm.abbas/"}
            />
          </div>
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          >
            <a
              href="mailto:dreamerfreelancer22.22@gmail.com"
              target={"_blank"}
              rel="noreferrer"
            >
              <span className=" font-Header tracking-wide text-gray-500 hover:text-AAsecondary hover:cursor-pointer">
                dreamerfreelancer22.22@gmail.com
              </span>
            </a>
          </motion.div>
